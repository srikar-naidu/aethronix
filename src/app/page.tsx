...
const features = [
  ...
  {
    title: 'Rural Heatmap',
    description: 'Visualizing talent and opportunity distribution',
    icon: Map,
    href: '/heatmap',
    color: 'text-teal-400'
  },
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-6">
                <span className="text-white">Skills Over </span>
              ...
              <p className="text-xl text-[var(--color-muted)] mb-8 leading-relaxed">
                AI-powered internship marketplace connecting rural talent with real industry work. Prove your skills, skip the resume screen.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--color-muted)] max-w-2xl mx-auto text-lg">
              A complete ecosystem designed to upskill, verify, and match talent with top-tier startup opportunities.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <Link href={feature.href} className="block h-full block group">
